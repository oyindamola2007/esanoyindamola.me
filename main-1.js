...
/* ──────────────────────────────────────────
   9. SEND BUTTON FORM SUBMISSION (EmailJS)
────────────────────────────────────────── */
(function initSendForm() {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    btn.disabled = true;
    btn.innerHTML = 'Sending… <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg>';
    ...
    try {
      ...
      await emailjs.send('service 843yd...', 'template bbz9e2z', {
        ...
        message:      message,
        to_email:     'esanoyindamola2007@gmail.com',
        reply_to:     email,
      });
      ...
      status.textContent = '❌ Failed to send. Please try again or contact us directly.';
      status.style.color = '#f87171';
    }
  });
})();
